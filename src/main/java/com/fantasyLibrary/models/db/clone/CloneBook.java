...
public class CloneBook {
	...
	@Column(name = "list_of_authors", length = 1600)
	private String listOfAuthors;
	
	@Column(name = "list_of_series", length = 600)
	private String listOfSeries;
	
	@Column(name = "list_of_genres", length = 500)
	private String listOfGenres;
	
	@Column(name = "sequence")
	private String sequence;
	
	@Column(name = "covers", length = 1800)
	...
	public String toString() {
		return "Book [id=" + id + ", title=" + title + ", publicationDate=" + publicationDate + ", description="
				...
				+ ", listOfAuthors=" + listOfAuthors + ", listOfSeries=" + listOfSeries + ", listOfGenres="
				+ listOfGenres + ", sequence=" + sequence + ", covers=" + covers + ", textReviewsCount="
				+ textReviewsCount + "]";
	}
}
